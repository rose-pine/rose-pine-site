...
export default defineLocale({
	...
	translations: {
		...
		"home.primary_action": "Explorer les thèmes",
		"home.feature.colours_and_community.title": "Couleurs & communauté",
		"home.feature.colours_and_community.description":
			"Rosé Pine est une palette élégante intégrée dans plus de {{REPOS_COUNT}} de vos applications préférées, grâce à nos formidables et généreux contributeurs.",
