...
export default defineLocale({
	...
	translations: {
		...
		"nav.resource.translate": "Übersetzung hinzufügen",
		"nav.social": "Soziales",
		"nav.header_label": "Primär",
		"nav.footer_label": "Sekundär",

		"command.trigger": "Öffne das Befehlsmenü",
		"command.title": "Befehlsmenü",
		"command.description": "Globale Seitensuche",
		...
		"home.feature.colours_and_community.title": "Farben und Gemeinschaft",
		...
		"themes.search_focus_cue": "Drücke / um zu fokussieren",
