	...
	>
		...
		<div class="flex shrink-0 items-center">
			...
			>
				<button
					on:click={() => (open = !open)}
					class="rounded-md bg-muted/5 px-2 py-1 text-sm text-subtle hover:bg-muted/10 focus:outline-none focus:ring"
				>
					Menu
				</button>
			...
			<div class="pl-3">
				<button
					...
					class="flex h-8 w-8 items-center justify-center rounded-full bg-muted/5 text-subtle focus:outline-none focus:ring"
				>
					<Search size={16} />
				</button>
			</div>
